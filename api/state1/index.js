...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const body = req.body || {};
      console.log('[Upstash] Full request body:', JSON.stringify(body));
      const state = body.state || body;
      console.log('[Upstash] Extracted state:', JSON.stringify(state));
      ...
      console.log('[Upstash] Payload to save:', JSON.stringify(state));
